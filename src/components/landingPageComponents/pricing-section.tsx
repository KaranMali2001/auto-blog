...
const pricingPlans = [
  {
    name: "Free",
    price: "Free",
    description: "Perfect for getting started with Auto Blog",
    features: ["5 commits per month", "LinkedIn posting", "Basic templates", "Community support"],
    popular: false,
    cta: "Get Started",
  },
  {
    ...
    monthlyPrice: 29,
    annualPrice: 24,
    description: "For professionals sharing their work",
    features: ["Unlimited commits", "LinkedIn & Twitter posting", "Priority AI processing", "Custom post templates", "Advanced analytics", "Multiple repositories"],
    popular: true,
  ...
  },
  {
    ...
    features: ["Everything in Pro", "Team collaboration", "Shared analytics", "Custom branding", "API access", "Dedicated support"],
    popular: false,
    cta: "Contact Sales",
  },
];
    ...
    <section className="relative py-24 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-white via-white to-white/60 bg-clip-text text-transparent mb-4">Choose your plan</h2>

          <p className="text-lg text-white/60 max-w-2xl mx-auto mb-8">Start sharing your developer journey today. Upgrade anytime as your needs grow.</p>
          ...
          {pricingPlans.map((plan, index) => (
            <motion.div
              ...
              className={`relative rounded-2xl p-8 backdrop-blur-sm border transition-all duration-300 ${
                plan.popular ? "bg-gradient-to-b from-[#e78a53]/10 to-transparent border-[#e78a53]/30 shadow-lg shadow-[#e78a53]/10" : "bg-white/5 border-white/10 hover:border-white/20"
              }`}
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <div className="bg-gradient-to-r from-[#e78a53] to-[#e78a53]/80 text-white text-sm font-medium px-4 py-2 rounded-full">Most Popular</div>
                </div>
              )}
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.4 }} className="text-center mt-16">
          ...
          <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="text-[#e78a53] hover:text-[#e78a53]/80 font-medium transition-colors">
