      ...
      >
        ...
        <div>
          <div className="grid grid-cols-12 gap-4 justify-center">
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                  <p className="max-w-[460px]">Connect your GitHub repositories seamlessly. We track your commits and automatically transform them into professional content.</p>
                </div>
              </div>
              <div className="pointer-events-none flex grow items-center justify-center select-none relative">
                <div className="relative w-full h-[400px] rounded-xl overflow-hidden" style={{ borderRadius: "20px" }}>
                  ...
                  <div className="absolute inset-0">
                    <img src="https://framerusercontent.com/images/UjqUIiBHmIcSH9vos9HlG2BF4bo.png" alt="Arrow-CoreExchange" className="w-full h-full object-cover rounded-xl" />
                  </div>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="flex items-center gap-8">
                      ...
                      >
                        <img src="https://framerusercontent.com/images/q43ivjLz67lXhWf6TKfLIh0FY.png" alt="Logo" className="w-full h-full object-cover" />
                      </motion.div>
            ...
            >
              <div className="flex flex-col gap-4">
                <h3 className="text-2xl leading-none font-semibold tracking-tight">AI-Powered Generation</h3>
                <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                  <p className="max-w-[460px]">Our advanced AI analyzes your code changes and crafts engaging narratives that your audience will love.</p>
                </div>
              </div>
            ...
            >
              <div className="flex flex-col gap-4">
                <h3 className="text-2xl leading-none font-semibold tracking-tight">Multi-Platform Publishing</h3>
                <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                  <p className="max-w-[460px]">Publish simultaneously to LinkedIn, Twitter, and more. One commit becomes multiple professional posts.</p>
                </div>
              </div>
            ...
            >
              <div className="flex flex-col gap-4">
                <h3 className="text-2xl leading-none font-semibold tracking-tight">Analytics & Insights</h3>
                <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                  <p className="max-w-[460px]">Track your content performance across platforms and optimize your developer presence.</p>
                </div>
              </div>
              <div className="flex grow items-center justify-center select-none relative min-h-[300px] p-4">
