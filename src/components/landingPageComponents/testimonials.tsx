...
const testimonials = [
  {
    name: "Arjun Mehta",
    username: "@arjdev",
    body: "Auto Blog has completely changed how I share my work. My commits now become engaging content automatically. Game changer.",
    img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Sara Lin",
    username: "@sara.codes",
    body: "As a full-time dev, I never had time to write LinkedIn posts. Now my GitHub activity does it for me. Pure magic.",
    img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Devon Carter",
    username: "@devninja",
    body: "My team's visibility on LinkedIn skyrocketed. One commit turns into professional posts in minutes, not hours.",
    img: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Priya Shah",
    username: "@priyacodes",
    body: "The AI understands context perfectly. My technical commits become accessible stories that non-devs can appreciate.",
    img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Leo Martin",
    username: "@leobuilds",
    body: "Finally, a tool that helps devs build their personal brand without writing marketing copy. Essential for growth.",
    img: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Chloe Winters",
    username: "@chloewinters",
    body: "I went from 0 visibility to being recognized in my tech community. Auto Blog handles all my content strategy.",
    img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Ayaan Malik",
    username: "@ayaan_dev",
    body: "As a solo founder, this saves me hours every week. I code, AI handles the storytelling. Perfect workflow.",
    img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Monica Reeves",
    username: "@monicareeves",
    body: "My clients are impressed with my consistent posting. They don't know it's automated, but I don't care - it works!",
    img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "James Roy",
    username: "@jamesrdev",
    body: "Game-changer for developer advocacy. Turn your GitHub into a content machine without lifting a finger.",
    ...
    <section id="testimonials" className="mb-24">
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-[540px]">
          ...
          <p className="mt-5 relative z-10 text-center text-lg text-zinc-500">Developers worldwide use Auto Blog to build their personal brand and share their coding journey effortlessly.</p>
        </div>
